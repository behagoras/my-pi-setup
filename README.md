...
## My fork — decisions and setup

Fork of [`davis7dotsh/my-pi-setup`](https://github.com/davis7dotsh/my-pi-setup), adapted for my
personal accounts and subscriptions.

**Read [`docs/`](docs/README.md) first** — it holds the decision records (which providers, why,
what's deliberately left out) and [`docs/SETUP.md`](docs/SETUP.md), my install path (which
supersedes the upstream `SETUP.md` above).

⚠️ Not installed anywhere yet — see `docs/SETUP.md`.
